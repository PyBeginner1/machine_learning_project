...
class DataIngestion:
    ...
    def download_housing_data(self) -> str:
        try:
            ...
            #Folder to store the download file
            ...
            logging.info(f'File has been downloaded: [{tgz_file_path}]') 
    ...
    def extract_tgz_file(self,tgz_file_path: str):
        try:
            ...
            logging.info(f'Extracting tgz file at:[{tgz_file_path}] to dir:[{raw_data_dir}]')
            #Extract
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            logging.info(f"Reading csv file at: [{housing_file_path}]")

            #Divide Dataset equally so that there is same distribution in train and test
